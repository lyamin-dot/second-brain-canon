...
Суть: канон системы переезжает в приватный repo `lyamin-dot/second-brain-canon`. Задача существует здесь указателем: состояние фаз, решения и тупики переноса живут в проекте-летописи, а не в лаборатории. Дублировать их сюда запрещено (`second-brain-git` 4.3).
